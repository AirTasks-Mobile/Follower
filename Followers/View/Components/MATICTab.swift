        ...
        GeometryReader { geo in
            VStack(alignment: .leading, spacing: 0) {
                ...
                TabView(selection: $tabSelect) {
                    ...
                    AddCoinTab(titleText: "Polygon Address Only", coinAddress: $maticAddress, nickName: $maticNickname, onAddCoin: onClick)
                        .tag(3)
            ...
            .onChange(of: homeVM.maticSignatures, perform: { _ in
                if tabSelect == 4 {
                    homeVM.fetchMaticTxnDetail()
                }
            })
