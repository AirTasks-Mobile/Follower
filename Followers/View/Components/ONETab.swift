        ...
        GeometryReader { geo in
            VStack(alignment: .leading, spacing: 0) {
                ...
                TabView(selection: $tabSelect) {
                    ...
                    ListTransactionTab(nick: $selectedOne.nick, id: $selectedOne.id, transactions: $homeVM.oneTransactions, isLoading: $oneLoading, stake: $isStakeTab, isLast: $isLast,isStake: true, onStake: onOneStake, loadMore: loadMoreTransactions, onAsset: { })
                        .tag(4)
                }
